...
var boolVisibility:Bool = false

class Confirm5ViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func onClickbtnBayar(_ sender: Any) {
        let succesVC = storyboard?.instantiateViewController(withIdentifier: String(describing: Success1ViewController.self)) as! Success1ViewController
