...
class Confirm8ViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func onClickbtnBayar(_ sender: Any) {
        let succesVC = storyboard?.instantiateViewController(withIdentifier: String(describing: Success4ViewController.self)) as! Success4ViewController
