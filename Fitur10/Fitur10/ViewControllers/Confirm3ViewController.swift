...
class Confirm3ViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func onClickbtnBayar(_ sender: Any) {
        let succesVC = storyboard?.instantiateViewController(withIdentifier: String(describing: Success3ViewController.self)) as! Success3ViewController
