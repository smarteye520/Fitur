//
//  InsertData4ViewController.swift
//  Fitur10
//
...
class InsertData4ViewController: UIViewController, UITextFieldDelegate, SwipeViewDataSource, SwipeViewDelegate, ContactsViewControllerDelegate{
    
    @IBOutlet weak var swipeView: SwipeView!
    
//    @IBOutlet weak var lblJenis: UILabel!
    @IBOutlet weak var lblPenyediaLayanan: UILabel!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let length = tfKodeBayar.text!.count
...
//    }
    ...
    @IBAction func onClickbtnSelanjutnya(_ sender: Any) {
        lblPenyediaLayanan.text = ""
        let confirmVC = storyboard?.instantiateViewController(withIdentifier: String(describing: Confirm4ViewController.self)) as! Confirm4ViewController
        navigationController?.pushViewController(confirmVC, animated: false)
    }
    
    public func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        
        if textField == self.tfKodeBayar {
            KeyboardAvoiding.avoidingView = self.avoidingView
        }
        return true
    }
...
//extension InsertData4ViewController: BottomPopupDelegate {
//
