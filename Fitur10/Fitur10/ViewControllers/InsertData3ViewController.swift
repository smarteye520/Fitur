//
//  InsertData3ViewController.swift
//  Fitur10
//
...
class InsertData3ViewController: UIViewController, UITextFieldDelegate, SwipeViewDataSource, SwipeViewDelegate { //}, ContactsViewControllerDelegate{
...
//        lblJenis.text = ""
        let confirmVC = storyboard?.instantiateViewController(withIdentifier: String(describing: Confirm3ViewController.self)) as! Confirm3ViewController
...
//extension InsertData3ViewController: BottomPopupDelegate {
//
