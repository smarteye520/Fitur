//
//  InsertData6ViewController.swift
//  Fitur10
//
...
class InsertData6ViewController: UIViewController, UITextFieldDelegate, SwipeViewDataSource, SwipeViewDelegate { //, ContactsViewControllerDelegate{
    
    @IBOutlet weak var swipeView: SwipeView!
    
//    @IBOutlet weak var lblJenis: UILabel!
    @IBOutlet weak var tfNorminal: UITextField!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let length = tfNorminal.text!.count
...
//    }
    ...
    @IBAction func onClickbtnSelanjutnya(_ sender: Any) {
        let confirmVC = storyboard?.instantiateViewController(withIdentifier: String(describing: Confirm6ViewController.self)) as! Confirm6ViewController
        navigationController?.pushViewController(confirmVC, animated: false)
    }
    
    public func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        
        if textField == self.tfNorminal {
            KeyboardAvoiding.avoidingView = self.avoidingView
        }
        return true
    }
...
/*
extension InsertData6ViewController: BottomPopupDelegate {
